...
public class Question4 {
    ...
    public static void main(String[] args) {
        ...
        Collection<File> files = question4.getFiles(Paths.get("D:\\app\\"));

        question4.setWordsInFilesToMap(files);
        question4.concurrentHashMap.forEachEntry(10, stringSetEntry -> System.out.println(stringSetEntry.getKey() + "::" + stringSetEntry.getValue()));
    }
